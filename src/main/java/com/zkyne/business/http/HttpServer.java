package com.zkyne.business.http;
...
public class HttpServer {
    ...
    /**
     * Start a HTTP server serving Prometheus metrics from the given registry using the given {@link com.sun.net.httpserver.HttpServer}.
     ...
     * The {@code httpServer} is expected to already be bound to an address
     */
    public HttpServer(com.sun.net.httpserver.HttpServer httpServer, String contextPath, CollectorRegistry registry, boolean daemon) throws IOException {
        ...
        if(contextPath != null && !"".equals(contextPath.trim())){
            server.createContext(contextPath.trim(), mHandler);
        }
    ...
    public HttpServer(InetSocketAddress addr, CollectorRegistry registry, boolean daemon) throws IOException {
        this(com.sun.net.httpserver.HttpServer.create(addr, 3), registry, daemon);
    }
    /**
     * Start a HTTP server serving Prometheus metrics from the given registry.
     */
    public HttpServer(InetSocketAddress addr, String contextPath, CollectorRegistry registry, boolean daemon) throws IOException {
        this(com.sun.net.httpserver.HttpServer.create(addr, 3), contextPath, registry, daemon);
    }
     ...
     * Start a HTTP server serving Prometheus metrics from the given registry using non-daemon threads.
     */
    public HttpServer(InetSocketAddress addr, String contextPath, CollectorRegistry registry) throws IOException {
        this(addr, contextPath, registry, false);
    }
     ...
     * Start a HTTP server serving the default Prometheus registry.
     */
    public HttpServer(int port, String contextPath, boolean daemon) throws IOException {
        this(new InetSocketAddress(port), contextPath, CollectorRegistry.defaultRegistry, daemon);
    }
     ...
     * Start a HTTP server serving the default Prometheus registry.
     */
    public HttpServer(String host, String contextPath, int port, boolean daemon) throws IOException {
        this(new InetSocketAddress(host, port), contextPath, CollectorRegistry.defaultRegistry, daemon);
    }
     ...
     * Start a HTTP server serving the default Prometheus registry using non-daemon threads.
     */
    public HttpServer(String host, String contextPath, int port) throws IOException {
        this(new InetSocketAddress(host, port), contextPath, CollectorRegistry.defaultRegistry, false);
    }
